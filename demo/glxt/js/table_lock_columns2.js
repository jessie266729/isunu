...
function pageInit(){
    ...
    $(init.scroll_area).scroll(function (){
        ...
        init.table_title_right.css('margin-left',(allWidthLeft-init.scroll_area.scrollLeft())+'px');
    });
    ...
    //table栏的hover效果
    init.table_area.find('tr').on('mouseover',function(){
        $('.'+$(this).attr('class')).addClass('hover-row');
    }).on('mouseout',function(){
        $('.'+$(this).attr('class').replace('hover-row','')).removeClass('hover-row');
    }).on('click',function(){
        init.table_area.find('tr').removeClass('hover-row').removeClass('active-row');
        $('.'+$(this).attr('class')).addClass('active-row');
    })
}
...
function listChangeWidth(){
    ...
    if(panelWidth - allWidthLeft > allWidthRight){
        ...
        //init.table_area.css('overflow-x','hidden');
        init.scroll_box.css('width',(allWidthLeft+allWidthRight)+'px');
    }
